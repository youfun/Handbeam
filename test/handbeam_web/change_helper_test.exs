defmodule HandbeamWeb.ChangeHelperTest do
  @moduledoc """
  Tests for HandbeamWeb.ChangeHelper — pure data transformation helpers
  for change/reversion extracted from HandbeamWeb.WorkspaceLive.
  """
