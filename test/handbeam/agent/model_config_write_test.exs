defmodule Handbeam.Agent.ModelConfigWriteTest do
  @moduledoc """
  ...
  setup do
    old_env = System.get_env("HANDBEAM_MODELS_FILE")
    ...
    on_exit(fn ->
      ...
      if old_env,
        do: System.put_env("HANDBEAM_MODELS_FILE", old_env),
  ...
  describe "ensure_config/0" do
    test "creates ~/.handbeam/models.json when it does not exist" do
    ...
    test "creates parent directory if needed" do
      ...
      System.put_env("HANDBEAM_MODELS_FILE", nested)
      on_exit(fn -> System.put_env("HANDBEAM_MODELS_FILE", config_path()) end)
    ...
    test "optional seed is used only when models.json is missing" do
      ...
      on_exit(fn -> System.delete_env("HANDBEAM_MODELS_SEED") end)
