defmodule Handbeam.Browser.WebViewSessionTest do
  use ExUnit.Case, async: false

  alias Handbeam.Browser.{Display, WebViewSession, WebViewSupervisor}
  ...
  setup do
    ...
    on_exit(fn ->
      if previous_engine do
        Application.put_env(:handbeam, :browser_engine, previous_engine)
      else
        Application.delete_env(:handbeam, :browser_engine)
      end

      if previous_host do
        Application.put_env(:handbeam, :host, previous_host)
      else
  ...
  defp install_fake!(fun) do
    Application.put_env(:handbeam, :browser_engine, fun)
  end
end
