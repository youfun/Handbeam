defmodule Handbeam.Log.FormatterTest do
  @moduledoc """
  Tests for Handbeam.Log.Formatter — event serialization and deserialization.
  """
  use ExUnit.Case, async: true

  alias Handbeam.Log.{Event, Formatter, Redactor}
