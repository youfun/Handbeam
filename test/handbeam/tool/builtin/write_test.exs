defmodule Handbeam.Tool.Builtin.WriteTest do
  @moduledoc """
  ...
  alias Handbeam.Tool.Builtin.Write
  ...
  describe "security — workspace boundary" do
    ...
    test "blocks symlink that points outside workspace" do
      # Handbeam security policy: symlink escape is blocked via validate_within_workspace.
