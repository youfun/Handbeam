defmodule Handbeam.Extension.UITest do
  use ExUnit.Case, async: true

  alias Handbeam.Extension.UI
  ...
  describe "set_status/3" do
    ...
    test "different sessions have isolated topics" do
      ...
      Phoenix.PubSub.subscribe(Handbeam.PubSub, topic1)
      Phoenix.PubSub.subscribe(Handbeam.PubSub, topic2)
