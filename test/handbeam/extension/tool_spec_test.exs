defmodule Handbeam.Extension.ToolSpecTest do
  use Handbeam.DataCase, async: true

  alias Handbeam.Extension.ToolSpec
  alias Handbeam.Extension.CommandSpec
  alias Handbeam.Extension.ProviderSpec
  ...
  describe "ToolSpec.new/3" do
    test "creates a valid tool spec" do
      ...
      assert spec.handbeam_name == "ext__agent-notify__notify_send"
    ...
    test "generates namespace: ext__<extension>__<tool>" do
      ...
      assert spec.handbeam_name == "ext__my-ext__my_tool"
    end
