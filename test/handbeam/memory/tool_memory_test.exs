defmodule Handbeam.Tool.MemoryTest do
  ...
  alias Handbeam.Tool.Memory.{MemLearn, MemRecall, MemReinforce, MemAssociate}
  alias Handbeam.Memory.MemoryStore
  ...
  describe "mem_learn tool" do
    ...
    test "stores short-term memory with expires_at set" do
      ...
      engram = Handbeam.Repo.get!(Handbeam.Memory.Engram, data.id)
  ...
  describe "mem_reinforce tool" do
    test "reinforces by id" do
      ...
      reloaded = Handbeam.Repo.get!(Handbeam.Memory.Engram, engram.id)
