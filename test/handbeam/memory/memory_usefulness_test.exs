defmodule Handbeam.Memory.MemoryUsefulnessTest do
  ...
  setup do
    ...
    Application.put_env(:handbeam, :observational_memory,
      enabled: true,
    ...
    on_exit(fn ->
      case previous do
        nil -> Application.delete_env(:handbeam, :observational_memory)
        value -> Application.put_env(:handbeam, :observational_memory, value)
      end
    end)
