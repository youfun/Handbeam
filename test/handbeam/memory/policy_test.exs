defmodule Handbeam.Memory.PolicyTest do
  @moduledoc """
  Tests for Handbeam.Memory.Policy — memory policy struct and candidate validation.
  ...
  describe "validate_candidate_memory/1 — content validation" do
    ...
    test "accepts a project convention" do
      {:ok, _} =
        Policy.validate_candidate_memory(
          "All LiveView modules live under HandbeamWeb and follow the naming pattern WorkspaceLive"
        )
    end
