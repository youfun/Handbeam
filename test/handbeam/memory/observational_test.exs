defmodule Handbeam.Memory.ObservationalTest do
  use ExUnit.Case, async: false

  alias Handbeam.Memory.{Observation, ObservationStore}
  alias Handbeam.Memory.ObservationalConfig, as: Config
  alias Handbeam.Agent.Config, as: AgentConfig
  ...
  describe "ObservationalAfterCompletion middleware" do
    alias Handbeam.Agent.Middleware.ObservationalAfterCompletion
    ...
    test "records scope metadata on completion observations" do
      Application.put_env(:handbeam, :observational_memory, enabled: true)
  ...
  describe "ObservationalAfterToolExec middleware" do
    alias Handbeam.Agent.Middleware.ObservationalAfterToolExec
