...
and metadata marked `visibility: internal` or `task` are rejected. This baseline
has no bounded internal-task tool; new task runtimes must preserve this exclusion.
