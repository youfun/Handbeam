defmodule Handbeam.MCP.DeferredBootstrap do
  @moduledoc """
  ...
  def handle_info(:bootstrap, state) do
    ...
    already_bootstrapped =
      Enum.any?(Handbeam.Tool.Registry.list(), &String.starts_with?(&1, "mcp__"))
    ...
    if already_bootstrapped do
      ...
      project = if Handbeam.ProjectTrust.enabled?(), do: project_dir(), else: nil

      case Handbeam.MCP.bootstrap(project: project) do
        {:ok, result} ->
