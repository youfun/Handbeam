defmodule Handbeam.Browser.WebViewSupervisor do
  @moduledoc """
  ...
  alias Handbeam.Browser.WebViewSession
  ...
  def lookup(conversation_id) when is_binary(conversation_id) do
    case Registry.lookup(Handbeam.Browser.WebViewRegistry, {:conversation, conversation_id}) do
