defmodule Handbeam.Agent.Middleware.ObservationalSessionStart do
  @moduledoc """
  ...
  alias Handbeam.Memory.{MemoryStore, ObservationStore}
  ...
  defp build_context_section(observations) do
    lines =
      observations
      |> Enum.reverse()
      |> Enum.map(&Handbeam.Memory.Observation.to_context_line/1)
