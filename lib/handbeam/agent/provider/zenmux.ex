defmodule Handbeam.Agent.Provider.ZenMux do
  @moduledoc """
  ...
  def complete(messages, tool_defs, config) do
    ...
    |> case do
      ...
      {:error, :missing_api_key} ->
        {:error,
         "ZENMUX_API_KEY not configured. Set `apiKey` in ~/.handbeam/models.json, pass :api_key in config, or set ZENMUX_API_KEY."}
    end
  end
