defmodule Handbeam.Agent.Provider.DeepSeek do
  @moduledoc """
  ...
  def complete(messages, tool_defs, config) do
    ...
    |> case do
      ...
      {:error, :missing_api_key} ->
        {:error,
         "DEEPSEEK_API_KEY not configured. Set `apiKey` in ~/.handbeam/models.json, pass :api_key in config, or set DEEPSEEK_API_KEY."}
    end
  end
