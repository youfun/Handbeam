defmodule Handbeam.SessionSupervisor do
  @moduledoc """
  Dynamic supervisor for `Handbeam.PubSub.Session` processes.
  ...
  def start_session(opts) when is_list(opts) do
    DynamicSupervisor.start_child(__MODULE__, {Handbeam.PubSub.Session, opts})
  end
