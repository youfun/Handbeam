defmodule Handbeam.Settings.ModelPolicy do
  @moduledoc """
  Form-shaped view of the workspace `models` policy in `.handbeam/settings.jsonc`.

  `Handbeam.Agent.ModelConfig.load_workspace_policy/1` returns the raw policy map;
