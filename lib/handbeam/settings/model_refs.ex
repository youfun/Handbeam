defmodule Handbeam.Settings.ModelRefs do
  @moduledoc """
  ...
  every registered workspace's `.handbeam/settings.jsonc` (Model/AI fields and the
  ...
  alias Handbeam.Settings.{ModelAIOverride, ModelAISettings, ModelPolicy}
