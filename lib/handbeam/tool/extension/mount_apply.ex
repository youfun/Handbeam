defmodule Handbeam.Tool.Extension.MountApply do
  ...
  def description do
    "Compile Elixir source in memory and register ext__* tools / child_spec workers. " <>
      ...
      "To keep a plugin, write it to .handbeam/extensions instead."
  end
  ...
  def execute(%{"name" => name, "source" => source}, _context)
    ...
    case Handbeam.Extension.Mount.mount(source, name: name) do
      {:ok, mount} ->
