defmodule Handbeam.Extension.Mount do
  @moduledoc """
  ...
  alias Handbeam.Extension.Supervisor, as: ExtSupervisor
      ...
      {:ok, modules} ->
        ...
        case validate_modules(modules, tool_modules, id) do
          ...
          :ok ->
            ...
            case Handbeam.Tool.Registry.replace_owner(owner, tool_modules) do
              :ok ->
  ...
  defp namespace_and_compile(quoted, generation) do
    ...
    if MapSet.size(defined_modules) == 0 do
      ...
      namespace = Module.concat(Handbeam.Extension.Mount.Generated, "Gen#{generation}")
