defmodule HandbeamProbe.NativeWorkspaces do
  ...
  alias HandbeamProbe.{NativeApproval, NativeFolderBrowser, NativeWorkspaceImport}
  ...
  def pref_path, do: Path.join(data_dir(), ".handbeam/native_ui.json")
  ...
  defp write_pref(data) do
    ...
    case Handbeam.JSON.encode(data) do
  ...
  defp data_dir, do: Handbeam.Host.data_dir()
