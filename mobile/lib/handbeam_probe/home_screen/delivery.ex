defmodule HandbeamProbe.HomeScreen.Delivery do
  @moduledoc """
  ...
  `HandbeamProbe.NativeArtifactDelivery`, whose typed platform requests complete through
  `HandbeamProbe.HomeScreen.Platform`.
  """

  alias HandbeamProbe.NativeArtifactDelivery
