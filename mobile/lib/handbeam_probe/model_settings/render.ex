defmodule HandbeamProbe.ModelSettings.Render do
  @moduledoc """
  Mob node tree for the native model settings overview.

  Renders from the `HandbeamProbe.ModelSettings` state only; no disk reads. Editor
  forms live in `HandbeamProbe.ModelSettings.RenderForms`, the delete sheet in
  `HandbeamProbe.ModelSettings.RenderConfirm`.
  """
