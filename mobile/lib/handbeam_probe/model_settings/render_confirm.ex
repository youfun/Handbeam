defmodule HandbeamProbe.ModelSettings.RenderConfirm do
  ...
  import HandbeamProbe.ModelSettings.Render, only: [settings_select: 3]
  alias Handbeam.Settings.ModelRefs
  alias HandbeamProbe.ModelSettings.{Labels, Providers}
