defmodule HandbeamProbe.ModelSettings.Forms do
  @moduledoc """
  Form constructors and catalog lookups for the native model settings.

  Pure helpers shared by `HandbeamProbe.ModelSettings.Providers` (actions) and the
  ...
  catalog goes through `Handbeam.Agent.ModelConfig.read_config/0` only.
  """
