defmodule HandbeamProbe.ModelSettings.Policy do
  @moduledoc """
  Workspace model allowlist editing for the native model settings.

  The form shape is `Handbeam.Settings.ModelPolicy.form/1`; edits stay in memory
  until `save/2`.
  """

  use Gettext, backend: HandbeamProbe.Gettext
  alias Handbeam.Agent.ModelConfig
  alias Handbeam.Settings.ModelPolicy
  alias HandbeamProbe.ModelSettings
  alias HandbeamProbe.ModelSettings.Defaults
