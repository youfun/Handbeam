defmodule HandbeamProbe.NativeWorkspaceOpen do
  @moduledoc """
  ...
  `HandbeamProbe.PendingRequests` (via `HomeScreen.Requests`): `request/2` and
  ...
  alias HandbeamProbe.{NativeArtifactDelivery, NativeFileViewer}
  ...
  defp run_io(socket, generation, work) do
    ...
    starter =
      Application.get_env(:handbeam_probe, :workspace_io_start) ||
        (&Task.Supervisor.start_child(HandbeamProbe.TaskSupervisor, &1))
