defmodule HandbeamProbe.Platform.IOS do
  @moduledoc """
  iOS host for `HandbeamProbe.Platform` requests.

  Android talks to Kotlin through the JNI `handbeam_browser` NIF. That NIF is
