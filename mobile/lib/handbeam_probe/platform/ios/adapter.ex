defmodule HandbeamProbe.Platform.IOS.Adapter do
  @moduledoc """
  Injectable iOS host adapter for `HandbeamProbe.Platform.IOS`.

  The default talks to stock Mob NIFs (`open_url` / `share_text` / `files_pick`)
  and the project `handbeam_ios` NIF for file present. Tests replace this module
  ...
  **submitted**; it is not a claim that the user finished the UI.
  ...
  @spec current() :: module()
  def current do
    Application.get_env(:handbeam_probe, :ios_platform_adapter, __MODULE__.Nif)
  end
end
