defmodule HandbeamProbe.PendingRequests do
  @moduledoc """
  The one request-correlation table of `HandbeamProbe.HomeScreen`.
  ...
  deadline}` plus a small `ctx`:
    ...
    * off-screen tasks started by `HandbeamProbe.HomeScreen.Async` (`ref` is the
