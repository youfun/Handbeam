defmodule HandbeamProbe.NativeWorkspaceTree do
  @moduledoc """
  ...
  alias HandbeamProbe.NativeWorkspaceOpen
  ...
  defp spawn_list(socket, relative_dir, offset, request) do
    ...
    max = Application.get_env(:handbeam_probe, :file_tree_max_entries, 256)
  ...
  defp list_fun do
    Application.get_env(:handbeam_probe, :workspace_files_list) ||
