defmodule HandbeamProbe.SettingsSupport do
  @moduledoc """
  UI-side parsing for the native settings forms.

  Persistence and catalog semantics live in `sigil`:
  `Handbeam.Settings.ModelAIOverride`, `Handbeam.Settings.ModelPolicy`,
  `Handbeam.Settings.ModelRefs`, `Handbeam.Settings.ModelCatalog`, and
  `Handbeam.Agent.ModelConfig.read_config/0`.
  """
