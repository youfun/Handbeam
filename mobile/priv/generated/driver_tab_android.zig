...
extern fn handbeam_storage_nif_init() callconv(.c) ?*anyopaque;
extern fn handbeam_notify_nif_init() callconv(.c) ?*anyopaque;
extern fn handbeam_browser_nif_init() callconv(.c) ?*anyopaque;
...
const base_nifs = [_]ErtsStaticNif{
    ...
    .{ .nif_init = handbeam_storage_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
    .{ .nif_init = handbeam_notify_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
    .{ .nif_init = handbeam_browser_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
};
