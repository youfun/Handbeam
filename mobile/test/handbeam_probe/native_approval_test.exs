defmodule HandbeamProbe.NativeApprovalTest do
  @moduledoc """
  ...
  @source Path.expand("../../lib/handbeam_probe/native_approval.ex", __DIR__)
  ...
  test "decide/4 reports rule_not_saved when the workspace rule cannot be written", %{
    ...
    # A regular file where the workspace root should be: `.handbeam/` cannot be created.
