defmodule HandbeamProbe.NativeWorkspaceOpenTest do
  use ExUnit.Case, async: false

  import Mob.Socket, only: [assign: 3]

  alias HandbeamProbe.HomeScreen.Requests
  alias HandbeamProbe.{NativeFileViewer, NativeWorkspaceOpen, PendingRequests}
  ...
  test "start_child failure is visible and not left loading" do
    Application.put_env(:handbeam_probe, :workspace_io_start, fn _ -> {:error, :noproc} end)
    socket = socket_fixture()
