defmodule HandbeamProbe.NativeWorkspacesTest do
  use ExUnit.Case, async: false

  alias Handbeam.{ConversationStore, WorkspaceStore}
  alias HandbeamProbe.{NativeFolderBrowser, NativeWorkspaceImport, NativeWorkspaces}
  ...
  test "drafts and preference restore are workspace-scoped", %{default: default, dir: dir} do
    ...
    assert File.exists?(Path.join(dir, ".handbeam/native_ui.json"))
  end
end
