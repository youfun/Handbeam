defmodule HandbeamProbe.NativePlatformTest do
  ...
  test "dist node is platform-specific" do
    assert NativePlatform.dist_node(:ios) == :"handbeam_probe_ios@127.0.0.1"
    assert NativePlatform.dist_node(:android) == :"handbeam_probe_android@127.0.0.1"
  end

  defp restore(nil), do: Application.delete_env(:handbeam_probe, :native_platform)
  defp restore(value), do: Application.put_env(:handbeam_probe, :native_platform, value)
end
