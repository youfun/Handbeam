// beam_jni.c — JNI entry points for HandbeamProbe.
// Generated by mix mob.new. Edit the two defines below; do not touch the rest.

#include <jni.h>
#include "mob_beam.h"

#define BRIDGE_CLASS  "com/example/handbeam_probe/MobBridge"
#define APP_MODULE    "handbeam_probe"
...
Java_com_example_handbeam_1probe_MainActivity_nativeSetActivity(JNIEnv* env, jobject thiz, jobject activity) {
    mob_init_bridge(env, activity);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MainActivity_nativeStartBeam(JNIEnv* env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MainActivity_nativeNotifyOrientation(JNIEnv* env, jobject thiz, jstring orient) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MainActivity_nativeNotifyConnectivity(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendTap(JNIEnv* env, jclass cls, jint handle) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendLongPress(JNIEnv* env, jclass cls, jint handle) {
    mob_send_long_press((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendDoubleTap(JNIEnv* env, jclass cls, jint handle) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSwipe(JNIEnv* env, jclass cls, jint handle,
                                                  jstring direction) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSwipeLeft(JNIEnv* env, jclass cls, jint handle) {
    mob_send_swipe_left((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSwipeRight(JNIEnv* env, jclass cls, jint handle) {
    mob_send_swipe_right((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSwipeUp(JNIEnv* env, jclass cls, jint handle) {
    mob_send_swipe_up((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSwipeDown(JNIEnv* env, jclass cls, jint handle) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendScroll(JNIEnv* env, jclass cls, jint handle,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendScrollBegan(JNIEnv* env, jclass cls, jint handle) {
    mob_send_scroll_began((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendScrollEnded(JNIEnv* env, jclass cls, jint handle) {
    mob_send_scroll_ended((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendScrollSettled(JNIEnv* env, jclass cls, jint handle) {
    mob_send_scroll_settled((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendTopReached(JNIEnv* env, jclass cls, jint handle) {
    mob_send_top_reached((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendScrolledPast(JNIEnv* env, jclass cls, jint handle) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSetThrottleConfig(JNIEnv* env, jclass cls, jint handle,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendDrag(JNIEnv* env, jclass cls, jint handle,
                                                 jdouble x, jdouble y, jdouble dx, jdouble dy,
                                                 jstring phase) {
    const char* ph = (*env)->GetStringUTFChars(env, phase, NULL);
    if (ph == NULL) return;
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendDismiss(JNIEnv* env, jclass cls, jint handle) {
    mob_send_dismiss((int)handle);
}

// Called from MobBridge.nativeSendChangeStr/Bool/Float when an input widget changes.
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendChangeStr(JNIEnv* env, jclass cls, jint handle, jstring value) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendChangeBool(JNIEnv* env, jclass cls, jint handle, jboolean value) {
    mob_send_change_bool((int)handle, (int)value);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendChangeFloat(JNIEnv* env, jclass cls, jint handle, jfloat value) {
    mob_send_change_float((int)handle, (double)value);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendFocus(JNIEnv* env, jclass cls, jint handle) {
    mob_send_focus((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendBlur(JNIEnv* env, jclass cls, jint handle) {
    mob_send_blur((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSendSubmit(JNIEnv* env, jclass cls, jint handle) {
    mob_send_submit((int)handle);
}

// Called from MobBridge.nativeHandleBack() when the Android back gesture fires.
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeHandleBack(JNIEnv* env, jclass cls) {
    mob_handle_back();
}
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeNotifyColorScheme(JNIEnv* env, jclass cls,
    jstring scheme) {
    if (!scheme) return;
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverAtom2(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverAtom3(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverMotion(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverMotionMag(JNIEnv* env, jclass cls,
    jlong pid, jdouble ax, jdouble ay, jdouble az,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverFileResult(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverPushToken(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverNotification(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeSetLaunchNotification(JNIEnv* env, jclass cls,
    jstring json) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverWebViewMessage(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverWebViewBlocked(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverAlertAction(JNIEnv* env, jclass cls,
    jstring action) {
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverComponentEvent(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbDevices(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbPermission(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbOpened(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbData(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbWriteComplete(JNIEnv* env, jclass cls,
    jlong pid, jint session_id, jint bytes_written) {
    mob_deliver_vendor_usb_write_complete(pid, (int)session_id, (int)bytes_written);
}

JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeDeliverVendorUsbEvent(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_handbeam_1probe_MobBridge_nativeCancelRuns(JNIEnv* env, jclass cls) {
    (void)env;
    (void)cls;
