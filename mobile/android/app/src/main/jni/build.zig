// build.zig — Android native build for handbeam_probe.
//
...
//     Output: libhandbeam_probe.so installed to
//     android/app/src/main/jniLibs/<abi>/libhandbeam_probe.so so
