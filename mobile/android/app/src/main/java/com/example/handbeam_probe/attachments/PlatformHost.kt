...
import com.example.handbeam_probe.BridgeIds
...
object PlatformHost {
    ...
    private fun deliver(requestId: String, generation: Int, result: String?, error: String?) {
        com.example.handbeam_probe.BrowserEngine.nativeDeliver(
            0L,
            ByteArray(0),
    ...
    private class Bound(private val cacheDir: File) {
        ...
        private fun launchExternal(
            ...
            activity.runOnUiThread {
                ...
                val current = com.example.handbeam_probe.MobBridge.activity()
        ...
        private fun save(session: HostSession, payload: JSONObject) {
            val activity = activityRef.get() as? com.example.handbeam_probe.MainActivity
            ...
            if (activity == null || com.example.handbeam_probe.MobBridge.activity() !== activity || activity.isFinishing) {
