...
/**
 * String contract shared with the Elixir side of Handbeam Probe.
 *
 ...
 * - [PlatformOps]: `"op"` values built by `HandbeamProbe.Platform.Request`
 *   (`lib/handbeam_probe/platform/request.ex`) and consumed by `PlatformHost`.
 * - [FilePick]: `"kind"` values `NativeWorkspaceImport` sends through
 *   `Mob.Files.pick` for the SAF directory picker.
 * - [Types] / [Props]: product node types and props that `HandbeamRender`
...
object BridgeIds {
    ...
    /** Product node types rendered by Handbeam composables instead of stock Mob. */
    object Types {
