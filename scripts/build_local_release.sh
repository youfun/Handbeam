...
#
# Result:
#   _build/local_release/prod/rel/handbeam
...
RELEASE_DIR="$MIX_BUILD_ROOT/$MIX_ENV/rel/handbeam"
PROD_CONFIG="config/prod.exs"
BACKUP_CONFIG="$(mktemp "${TMPDIR:-/tmp}/handbeam-prod.exs.XXXXXX")"
...
echo "========================================"
echo " Handbeam Local/LAN Release 构建脚本"
echo "========================================"
echo "当前环境:      $MIX_ENV"
...
echo ""
echo "➡ 构建 OTP Release..."
MIX_ENV="$MIX_ENV" MIX_BUILD_ROOT="$MIX_BUILD_ROOT" mix release handbeam --overwrite
